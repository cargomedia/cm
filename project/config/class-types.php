...
// This is autogenerated class types config file. You should not adjust changes manually.
// You should adjust TYPE constants and regenerate file using www/cron/generate-config-class-types.php
