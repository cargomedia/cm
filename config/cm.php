...
//$config->objects_cdn = 'http://cdn.fuckbook.com/';
//$config->content_cdn = 'http://cdn.fuckbook.com/';
$config->debug = true;
$config->timeZone = 'US/Central';
$config->testIp = '127.0.0.1';

$config->CM_Search = new stdClass();
$config->CM_Search->enabled = true;
$config->CM_Search->servers = array(array('host' => 'localhost', 'port' => 9200),);
...
$config->CM_Cache_Memcache->servers = array(array('host' => 'localhost', 'port' => 11211),);
...
$config->CM_StreamAdapter_Abstract->servers = array(array('host' => 'localhost', 'port' => 80),);
...
$config->CM_Mail->siteEmailAddress = 'noreply@cargomedia.ch';
...
$config->CM_Response_RPC->catch = array('CM_Exception_AuthRequired',);
