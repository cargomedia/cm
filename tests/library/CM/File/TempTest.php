...
class CM_File_TempTest extends TestCase {
	...
	public function testCreate() {
		$file = CM_File_Temp::create('foo.txt');
		$this->assertInstanceOf('CM_File_Temp', $file);
	...
	public function testDelete() {
		...
		try {
			new CM_File_Temp($file->getUniqid());
