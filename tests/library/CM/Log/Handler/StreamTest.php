...
class CM_Log_Handler_StreamTest extends CMTest_TestCase {
    ...
    public function testFormatting() {
        ...
        $handler = new CM_Log_Handler_Stream('foo', $mockStreamInterface);
        ...
        $handler = new CM_Log_Handler_Stream('foo', $mockStreamInterface, CM_Log_Logger::INFO, '{message} | {datetime} | {levelname}', 'H:i:s');
        $formattedMessage = $this->forceInvokeMethod($handler, '_formatRecord', [$record]);
