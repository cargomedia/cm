    ...
    public function testGetSignificance_lookElsewhereEffect() {
        foreach (array(
                     ...
                     array(1000, 498, 249, 1000, 251, 251, 1000, 126, 252,
                         false, 0.98986820631101, false, 0.98862625840294, false, 0.99898680486265),
                     array(1000, 490, 245, 1000, 255, 255, 1000, 130, 260,
                         false, 0.77635542902801, false, 0.75390936914126, false, 0.97544865166949),
                     array(1000, 480, 240, 1000, 260, 260, 1000, 135, 270,
                         false, 0.36941028927436, false, 0.33241363765634, false, 0.90752065159917),
                     array(1000, 460, 230, 1000, 270, 270, 1000, 145, 290,
                         false, 0.022693838197528, false, 0.016298794245058, false, 0.69105554598148),
                     array(1000, 440, 220, 1000, 280, 280, 1000, 155, 310,
                         true, 0.00029558277514585, true, 0.000163634205672, false, 0.45319155112193),
                     array(1000, 420, 210, 1000, 290, 290, 1000, 165, 330,
                         true, 0.0000008400786187801, true, 0.00000036485749843607, false, 0.2618673860067),
                 ) as $list) {
            list(
