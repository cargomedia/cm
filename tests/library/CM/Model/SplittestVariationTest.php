    ...
    public function testGetSignificance_lookElsewhereEffect() {
        foreach (array(
                     ...
                     array(1000, 498, 249, 1000, 251, 251, 1000, 126, 252,
                         false, 0.89934318856137, false, 0.89335225460865, false, 0.96816927369115),
                     array(1000, 490, 245, 1000, 255, 255, 1000, 130, 260,
                         false, 0.52708925686554, false, 0.50392477298424, false, 0.84331130120359),
                     array(1000, 480, 240, 1000, 260, 260, 1000, 135, 270,
                         false, 0.20590321073207, false, 0.18294041689503, false, 0.69589582640017),
                     array(1000, 460, 230, 1000, 270, 270, 1000, 145, 290,
                         false, 0.011412036386002, true, 0.008182876859377, false, 0.44417228027156),
                     array(1000, 440, 220, 1000, 280, 280, 1000, 155, 310,
                         true, 0.0001478023103344, true, 0.000081820450129055, false, 0.26053502525267),
                     array(1000, 420, 210, 1000, 290, 290, 1000, 165, 330,
                         true, 0.00000042003939759727, true, 0.00000018242876587138, false, 0.14085355497837),
                 ) as $list) {
            list(
