...
class CM_Site_SiteFactoryTest extends CMTest_TestCase {
    ...
    public function testFindSite() {
        $site1 = $this->getMockSite(null, null, null, ['url' => 'http://my-site.com']);
        $site2 = $this->getMockSite(null, null, null, ['url' => 'http://my-site.com/hello']);
        $site3 = $this->getMockSite(null, null, null, ['url' => 'http://your-site.com']);
