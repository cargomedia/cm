...
class CM_CssLegacyTest extends TestCase {
...
EOD;
		$actual = new CM_CssLegacy($css, $this->_getRender(), new CM_CssLegacy($presets, $this->_getRender()));
...
EOD;
		$actual = new CM_CssLegacy($css, $this->_getRender());
		$this->assertEquals($expected, $actual->__toString());
	}
...
EOD;
		$actual = new CM_CssLegacy($css, $this->_getRender(), new CM_CssLegacy($presets, $this->_getRender()), '.cmp-test');
		$this->assertEquals($expected, $actual->__toString());
	}
...
EOD;
		$actual = new CM_CssLegacy($css, $this->_getRender(), null, '.prefix');
		$this->assertEquals($expected, $actual->__toString());
	}
