...
class smarty_function_linkTest extends CMTest_TestCase {
	...
	public function testWithLabel() {
		...
		$this->_assertSame('<a href="http://www.default.dev/test" class="link hasLabel"><span class="label">Label</span></a>', array('page' => 'CM_Page_Test', 'label' => 'Label'));
		$this->_assertSame('<a href="http://www.default.dev/test" class="link testClass hasLabel"><span class="label">Label</span></a>', array('page' => 'CM_Page_Test', 'label' => 'Label', 'class' => 'testClass'));
		$this->_assertSame('<a href="http://www.default.dev/test" class="link hasLabel hasIcon"><span class="icon icon-delete"></span><span class="label">Label</span></a>', array('page' => 'CM_Page_Test', 'label' => 'Label', 'icon' => 'delete'));
		$this->_assertSame('<a href="http://www.default.dev/test" class="link hasLabel" title="Title"><span class="label">Label</span></a>', array('page' => 'CM_Page_Test', 'label' => 'Label', 'title' => 'Title'));
		$this->_assertSame('<a href="http://www.default.dev/test" class="link testClass hasLabel hasIcon" title="Title"><span class="icon icon-delete"></span><span class="label">Label</span></a>', array('page' => 'CM_Page_Test', 'label' => 'Label', 'class' => 'testClass', 'icon' => 'delete', 'title' => 'Title'));
	}
	...
	public function testWithoutLabel() {
		...
		$this->_assertSame('<a href="http://www.default.dev/test" class="link testClass hasLabel"><span class="label">http://www.default.dev/test</span></a>', array('page' => 'CM_Page_Test', 'class' => 'testClass'));
		$this->_assertSame('<a href="http://www.default.dev/test" class="link hasIcon"><span class="icon icon-delete"></span></a>', array('page' => 'CM_Page_Test', 'icon' => 'delete'));
		$this->_assertSame('<a href="http://www.default.dev/test" class="link" title="Title"></a>', array('page' => 'CM_Page_Test', 'title' => 'Title'));
		$this->_assertSame('<a href="http://www.default.dev/test" class="link testClass hasIcon" title="Title"><span class="icon icon-delete"></span></a>', array('page' => 'CM_Page_Test', 'class' => 'testClass', 'icon' => 'delete', 'title' => 'Title'));
	}
