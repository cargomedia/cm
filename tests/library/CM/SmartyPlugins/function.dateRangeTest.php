        ...
        foreach ([[
            ...
            'expected' =>
                (CMTest_TH::getVersionICU() < 50)
                    ? '<span class="date-range">2/1/03 12:34 – now (<span class="date-period">' . $yearsAgo . ' years</span>)</span>'
                    : '<span class="date-range">2/1/03, 12:34 – now (<span class="date-period">' . $yearsAgo . ' years</span>)</span>'
            ,
        ], [
            ...
            'expected' =>
                (CMTest_TH::getVersionICU() < 50)
                    ? '<span class="date-range">2/1/03 12:34 – 2/1/03 13:45 (<span class="date-period">1 hour</span>)</span>'
                    : '<span class="date-range">2/1/03, 12:34 – 2/1/03, 13:45 (<span class="date-period">1 hour</span>)</span>'
            ,
        ], [
            ...
            'expected' =>
                (CMTest_TH::getVersionICU() < 50)
                    ? '<span class="date-range">2/1/03 12:34 – 2/1/03 13:45 (<span class="date-period">01:11:10</span>)</span>'
                    : '<span class="date-range">2/1/03, 12:34 – 2/1/03, 13:45 (<span class="date-period">01:11:10</span>)</span>'
            ,
        ], [
            ...
            'expected' =>
                (CMTest_TH::getVersionICU() < 50)
                    ? '<span class="date-range">2/1/03 12:34:00 – 2/1/03 13:45:10 (<span class="date-period">01:11:10</span>)</span>'
                    : '<span class="date-range">2/1/03, 12:34:00 – 2/1/03, 13:45:10 (<span class="date-period">01:11:10</span>)</span>'
            ,
        ], [
            ...
            'expected' =>
                (CMTest_TH::getVersionICU() < 50)
                    ? '<span class="date-range">2/1/03 12:34 – 2/2/03 13:45 (<span class="date-period">1 day</span>)</span>'
                    : '<span class="date-range">2/1/03, 12:34 – 2/2/03, 13:45 (<span class="date-period">1 day</span>)</span>'
            ,
        ], [
