...
class CM_Paging_FileUserContent_StreamChannelMediaThumbnailsTest extends CMTest_TestCase {

    public function testPaging() {
        $streamChannel = CMTest_TH::createStreamChannel();
        $paging = new CM_Paging_FileUserContent_StreamChannelMediaThumbnails($streamChannel);
