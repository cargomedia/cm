...
class CM_Usertext_Filter_MaxLengthTest extends CMTest_TestCase {
    ...
    public function testProcess() {
        ...
        $this->assertSame('Hello…', $filter->transform('Hello World', new CM_Frontend_Render()));

        $filter = new CM_Usertext_Filter_MaxLength(11);
        $this->assertSame('Hello World', $filter->transform('Hello World', new CM_Frontend_Render()));
    ...
    public function testMultibyte() {
        ...
        $this->assertSame('繁體…', $filter->transform('繁體字', new CM_Frontend_Render()));
    }
}
