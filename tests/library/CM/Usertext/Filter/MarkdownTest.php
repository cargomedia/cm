...
class CM_Usertext_Filter_MarkdownTest extends CMTest_TestCase {
    ...
    public function testProcessWithImgLazy() {
        ...
        $expected = "<h1>Headline</h1>\n<ul>\n<li>element1</li>\n<li>element1</li>\n</ul>\n<p>paragraph</p>\n<p>foo_bar_foo</p>\n<p>foo <em>bar</em> foo</p>\n<p>Link: <a href=\"http://www.google.com\">google.com</a></p>\n<p>test2</p>\n<p><div class=\"ratioKeeper\"><div class=\"ratioKeeper-ratio\" style=\"padding-bottom:50%; width: 200px;\"></div><img data-src=\"/path/to/img.jpg\" alt=\"Img text\" class=\"lazy ratioKeeper-content\"/></div></p>\n";
