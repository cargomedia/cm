...
class CM_AppTest extends CMTest_TestCase {
...
EOD;
		$app = $this->getMockBuilder('CM_App')->setMethods(array('getActionVerbs'))->getMock();
		$app->expects($this->any())->method('getActionVerbs')->will($this->returnValue($actionVerbs));

		/** @var CM_App $app */
		$this->assertSame($expected, $app->generateConfigActionVerbs());
		$this->assertSame($expected, $app->generateConfigActionVerbs());
	}
