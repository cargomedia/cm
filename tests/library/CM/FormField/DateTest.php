...
class CM_FormField_DateTest extends CMTest_TestCase {
    ...
    public function testRenderWithEnvironmentTimezone() {
        ...
        $environment = $this->getDefaultEnvironment(null, null, null, new DateTimeZone('America/New_York'));
    ...
    public function testValidateWithEnvironmentTimezone() {
        ...
        $environment = $this->getDefaultEnvironment(null, null, null, new DateTimeZone('Asia/Tokyo'));
