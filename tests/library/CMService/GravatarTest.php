...
class CMService_GravatarTest extends CMTest_TestCase {
    ...
    public function testGetUrl() {
        ...
        $this->assertSame('https://secure.gravatar.com/avatar/55502f40dc8b7c769880b10874abc9d0?d=http://example.com/default.jpg', $gravatar->getUrl('test@example.com', null, 'http://example.com/default.jpg'));
        $this->assertSame('https://secure.gravatar.com/avatar/55502f40dc8b7c769880b10874abc9d0?s=140&d=http://example.com/default.jpg', $gravatar->getUrl('test@example.com', 140, 'http://example.com/default.jpg'));
