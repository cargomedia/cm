 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Cargomedia_Sniffs_Commenting_FunctionCommentSniff implements PHP_CodeSniffer_Sniff
{
	...
	protected function processParams($commentStart)
	{
		...
		if (empty($params) === false) {
			...
			foreach ($params as $param) {
				...
				$spaceCount = preg_match_all('/\s/', $param->getWhitespaceBeforeVarName(), $matches);
				if ($spaceCount < $spaceBeforeVar) {
					$spaceBeforeVar = $spaceCount;
					$longestType    = $errorPos;
				}

				$spaceCount = preg_match_all('/\s/', $param->getWhitespaceBeforeComment(), $matches);
