...
class CM_Component_Example extends CM_Component_Abstract {
    ...
    public function ajax_test(CM_Params $params, CM_Frontend_JavascriptContainer $handler, CM_Response_View_Ajax $response) {
        $x = $params->getString('x');
        sleep(2);
        return 'x=' . $x;
    }

    public function ajax_error(CM_Params $params, CM_Frontend_JavascriptContainer $handler, CM_Response_View_Ajax $response) {
    ...
    public function ajax_ping(CM_Params $params, CM_Frontend_JavascriptContainer $handler, CM_Response_View_Ajax $response) {
