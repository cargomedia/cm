...
class CM_Form_ExampleIcon extends CM_Form_Abstract {
    ...
    public function setup() {
        ...
        $this->registerField('sizeSlider', new CM_FormField_Integer(6, 120, 1));
        ...
        $this->registerField('shadowX', new CM_FormField_Integer(0, 20, 1));
        $this->registerField('shadowY', new CM_FormField_Integer(0, 20, 1));
        $this->registerField('shadowBlur', new CM_FormField_Integer(0, 20, 2));
    }
