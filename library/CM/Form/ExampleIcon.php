...
class CM_Form_ExampleIcon extends CM_Form_Abstract {
    ...
    public function setup() {
        $this->registerField('sizeSlider', new CM_FormField_Integer(['min' => 6, 'max' => 120]));
        ...
        $this->registerField('shadowX', new CM_FormField_Integer(['min' => 0, 'max' => 20]));
        $this->registerField('shadowY', new CM_FormField_Integer(['min' => 0, 'max' => 20]));
        $this->registerField('shadowBlur', new CM_FormField_Integer(['min' => 0, 'max' => 20]));
    }
