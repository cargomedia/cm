...
if (!$isInnoDb('cm_streamChannel_video')) {
	...
	CM_Db_Db::exec("ALTER TABLE `cm_streamChannel_video` ADD CONSTRAINT `cm_streamChannel_video-cm_streamChannel` FOREIGN KEY (`id`) REFERENCES `skadate`.`cm_streamChannel` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;");
}
